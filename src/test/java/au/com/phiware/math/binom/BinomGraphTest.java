...
public class BinomGraphTest {
	...
	public void testRow(int n) {
		...
		for(int k = 0; k <= n; k++) {
			...
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k);
	...
	public void testRowStorage(int n) {
		...
		for(int k = 0; k <= n; k++) {
			BinomCounter.resetCounter();
			assertTrue("binom for "+n+" choose "+k+" should be non-zero", new BinomGraph<Integer>(arithmetics, n, k).intValue() > 0);
	...
	public void testLongRow() {
		...
		for(int k = 0; k <= n; k++) {
			BinomCounter.resetCounter();
			Binom<Long> binom = new BinomGraph<Long>(arithmetics, n, k);
	...
	@Test
	public void testLongAndInteger() throws ClassNotFoundException {
		BitArithmetic<Integer> intMath = ArithmeticFactory.getBitArithmetic(Integer.class);
		BitArithmetic<Long> longMath = ArithmeticFactory.getBitArithmetic(Long.class);
		int n = 36, k = 11;
		int intExpected = 600805296;
		BinomCounter.resetCounter();
		assertEquals(n + " choose " + k, intExpected, (new BinomGraph<Integer>(intMath, n, k)).intValue());
		assertTrue("Should be efficient at "+n+" choose "+k, BinomCounter.hasAllOnes());

		BinomCounter.resetCounter();
		assertEquals(n + " choose " + k, (long) intExpected, (new BinomGraph<Long>(longMath, n, k)).longValue());
		assertTrue("Should be efficient at "+n+" choose "+k, BinomCounter.hasAllOnes());

		n = 36; k = 18;
		long longExpected = 9075135300L;
		BinomCounter.resetCounter();
		assertEquals(n + " choose " + k, longExpected, (new BinomGraph<Long>(longMath, n, k)).longValue());
		assertTrue("Should be efficient at "+n+" choose "+k, BinomCounter.hasAllOnes());
	}
	...
	public void testBigRow() {
		...
		for(int k = 0; k <= n; k++) {
			BinomCounter.resetCounter();
			Binom<BigInteger> binom = new BinomGraph<BigInteger>(arithmetics, n, k);
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#sum()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#up()}.
	 */
	@Test
	public void testUp() {
		BitArithmetic<Integer> arithmetics = IntegerArithmetic.getInstance();
		for(int n = 1; n <= 10; n++)
		for(int k = 0; k <= n; k++) {
			Binom<Integer> expected = new BinomGraph<Integer>(arithmetics, n + 1, k);
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).up();
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#down()}.
	 */
	@Test
	public void testDown() {
		...
		for(int k = 0; k < n; k++) {
			...
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).down();
			assertEquals((n - 1) + " choose " + k, expected.intValue(), binom.intValue());
			assertEquals("Row of " + (n - 1) + " choose " + k, expected.getRow(), binom.getRow());
			assertEquals("Column of " + (n - 1) + " choose " + k, expected.getColumn(), binom.getColumn());
			assertTrue("Should be efficient at "+(n - 1)+" choose "+k, BinomCounter.hasAllOnes());
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#next()}.
	 */
	@Test
	public void testNext() {
		...
		for(int n = 1; n <= 10; n++)
		for(int k = 0; k < n; k++) {
			Binom<Integer> expected = new BinomGraph<Integer>(arithmetics, n + 1, k + 1);
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).next();
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#back()}.
	 */
	@Test
	public void testBack() {
		...
		for(int k = 1; k <= n; k++) {
			...
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).back();
			assertEquals((n - 1) + " choose " + (k - 1), expected.intValue(), binom.intValue());
			assertEquals("Row of " + (n - 1) + " choose " + (k - 1), expected.getRow(), binom.getRow());
			assertEquals("Column of " + (n - 1) + " choose " + (k - 1), expected.getColumn(), binom.getColumn());
			assertTrue("Should be efficient at "+(n - 1)+" choose "+(k - 1), BinomCounter.hasAllOnes());
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#right()}.
	 */
	@Test
	public void testRight() {
		...
		for(int n = 2; n <= 10; n++)
		for(int k = 0; k <= n - 1; k++) {
			Binom<Integer> expected = new BinomGraph<Integer>(arithmetics, n, k + 1);
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).right();
	...
	/**
	 * Test method for {@link au.com.phiware.math.binom.BinomGraph#left()}.
	 */
	@Test
	public void testLeft() {
		...
		for(int k = 1; k <= n; k++) {
			...
			expected.value();
			BinomCounter.resetCounter();
			Binom<Integer> binom = new BinomGraph<Integer>(arithmetics, n, k).left();
			assertEquals(n + " choose " + (k + 1), expected.intValue(), binom.intValue());
			assertEquals("Row of " + n + " choose " + (k + 1), expected.getRow(), binom.getRow());
			assertEquals("Column of " + n + " choose " + (k + 1), expected.getColumn(), binom.getColumn());
			//assertTrue("Should be efficient at "+n+" choose "+(k + 1), BinomCounter.hasAllOnes());
