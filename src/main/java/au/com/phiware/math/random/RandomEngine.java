...
public abstract class RandomEngine<T extends Number> implements com.google.common.base.Supplier<T> {

	public static interface Builder<T extends Number> {
		public RandomEngine<T> build();
		public RandomEngine<T> build(int seed);
		public RandomEngine<T> build(Date seed);
	}
 ...
 */
public static <T extends Number> RandomEngine.Builder<T> builder(Class<T> type) {
